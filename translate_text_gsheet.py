...
engine = create_engine(URL(
                    account = 'wnspdch-yd20310',
                    user = 'ABHISHEKP',
                    password = 'Abhi@132004',
                    database = 'TEST',
                    schema = 'public',
...
with engine.connect() as conn:
    try:
        query = """select title from TEST.PUBLIC.TESTPR"""
        ...
        loop_counter = 0
        chunk_size = 100
        file_name = 'OTODOM_ANALYSIS_main'
        user_email = 'abhishek.pokale004@gmail.com'
